...
typedef struct gNB_RRC_UE_s {
  ...
  // X2-U (for dual-connectivity data splitting)
  int nb_x2u_e_rabs ;
      
  uint32_t gnb_gtp_x2u_teid[S1AP_MAX_E_RAB];
  transport_layer_addr_t gnb_gtp_x2u_addrs[S1AP_MAX_E_RAB];
  rb_id_t gnb_gtp_x2u_ebi[S1AP_MAX_E_RAB];
