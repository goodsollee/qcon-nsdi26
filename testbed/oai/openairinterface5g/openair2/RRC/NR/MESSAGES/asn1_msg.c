                                             ...
                                             e_NR_SecurityConfig__keyToUse key_to_use)
{
  ...
  //drb_ToAddMod->reestablishPDCP = NR_DRB_ToAddMod__reestablishPDCP_true;
  //drb_ToAddMod->recoverPDCP = NR_DRB_ToAddMod__recoverPDCP_true;
  ...
  // PAVE
  drb_ToAddMod->pdcp_Config->moreThanOneRLC = calloc(1,sizeof(*drb_ToAddMod->pdcp_Config->moreThanOneRLC));
  
  asn1cCallocOne(drb_ToAddMod->pdcp_Config->moreThanOneRLC->primaryPath.cellGroup, 1);
  //asn1cCallocOne(drb_ToAddMod->pdcp_Config->moreThanOneRLC->primaryPath.logicalChannel, 4);
  asn1cCallocOne(drb_ToAddMod->pdcp_Config->moreThanOneRLC->ul_DataSplitThreshold, NR_UL_DataSplitThreshold_infinity);
  asn1cCallocOne(drb_ToAddMod->pdcp_Config->moreThanOneRLC->pdcp_Duplication, false);
  ...
  LOG_E(RRC, "ASN1 for NSA RRC completed\n");
