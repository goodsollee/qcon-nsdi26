                                                       ...
                                                       OCTET_STRING_t *scg_RB_config)
{
  ...
  struct LTE_DRB_ToAddMod__ext4                           ext4;                 
  struct LTE_RLC_Config_v1510                             rlc_v1510;
#endif
  ...
  memset(&rlc_v1510, 0, sizeof(rlc_v1510));
#endif
  ...
  // Set the specific parameters for RLC v1510
  rlc_v1510.reestablishRLC_r15 = LTE_RLC_Config_v1510__reestablishRLC_r15_true;  // Example parameter setting

  // Assign the rlc_v1510 structure to the ext4 structure
  ext4.rlc_Config_v1510 = &rlc_v1510;

  // Now assign the ext4 structure to the DRB
  drb.ext4 = &ext4;

  lc.ul_SpecificParameters = &ul_params;
#endif
  // PAVE .. should LTE release drb? we commented this
  /* release drb 1 */
  /* PAVE will use LTE drb
  drb = 1;
  asn1cSeqAdd(&drb_list.list, &drb);
  ...
  */
  ...
  nr.choice.setup.endc_ReleaseAndAdd_r15 = 1;  /* FALSE */


  //scg_group_config = NULL;
  //scg_RB_config = NULL;
