...
// PAVE
int x2ap_gNB_generate_data_forwarding (x2ap_eNB_instance_t *instance_p, x2ap_eNB_data_t *x2ap_eNB_data_p, x2ap_ENDC_sgnb_data_forwarding_t *x2ap_sgnb_data_forwarding);
...
// PAVE
/*
int x2ap_eNB_generate_ENDC_x2_data_forwarding(x2ap_eNB_instance_t *instance_p, x2ap_eNB_data_t *x2ap_eNB_data_p,
                                                    int x2_id_source, int x2_id_target, x2ap_cause_t cause);

int x2ap_gNB_generate_ENDC_x2_data_forwarding(x2ap_eNB_instance_t *instance_p, x2ap_eNB_data_t *x2ap_eNB_data_p,
                                                   int menb_ue_x2ap_id, int sgnb_ue_x2ap_id);
*/
