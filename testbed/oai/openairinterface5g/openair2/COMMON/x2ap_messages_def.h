...
// PAVE
MESSAGE_DEF(X2AP_ENDC_SGNB_DATA_FORWARDING     , MESSAGE_PRIORITY_MED, x2ap_ENDC_sgnb_data_forwarding_t, x2ap_ENDC_sgnb_data_forwarding)

// Dual-connectivity
MESSAGE_DEF(X2AP_ENDC_LTE_INFO_INDICATION,         MESSAGE_PRIORITY_MED,      x2ap_ENDC_lte_info_indication_t, x2ap_ENDC_lte_info_indication)
