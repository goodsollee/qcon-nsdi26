...
#define R(d) do { if (nr_rlc_pdu_decoder_in_error(&d)) goto err; } while (0)
  ...
  entity->common.stats.prev_txsdu_bytes = entity->common.stats.txsdu_bytes;
...
process_wait_list_head:
       ...
       * if fully acked
       */
      // PAVE: Successful delivered! Calculate throughput and queue size!
    ...
    nr_rlc_entity_t *_entity, int maxsize)
{
  ...
  ret.tx_bytes = entity->common.stats.txsdu_bytes - entity->common.stats.prev_txsdu_bytes;
  ret.total_tx_bytes = entity->common.stats.txsdu_bytes;
