...
typedef struct {
    int rnti[MAX_UE];
    forward_info_t info[MAX_UE];
} forward_info_map_t;


extern forward_info_map_t g_forward_info_map;
extern forward_info_map_t g_forward_info_map_lte;

// Changed return types to void to match the implementation
...
/*NR link info update for dual-connectivity*/
void nr_pdcp_dc_info_update (int ue_id, int acked_bytes, int queue_size);

/*LTE link info update for dual-connectivity*/
