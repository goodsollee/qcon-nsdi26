...
extern "C" {
  ...
  /*Dual-connectivity control info*/ 
  typedef bool (*x2u_info_callback)(protocol_ctxt_t  *ctxt_pP,
                              const rb_id_t        rb_idP,
                              const int            queue_size,
                              const int            bytes);

  
  typedef bool (*x2u_dl_data_callback)(protocol_ctxt_t  *ctxt_pP,
                              const srb_flag_t     srb_flagP,
                              const rb_id_t        rb_idP,
                              const mui_t          muiP,
                              const confirm_t      confirmP,
  ...
  typedef bool (*x2u_ul_data_callback)(protocol_ctxt_t  *ctxt_pP,
                              const srb_flag_t     srb_flagP,
                              const rb_id_t        rb_idP,
                              const mui_t          muiP,
                              const confirm_t      confirmP,
